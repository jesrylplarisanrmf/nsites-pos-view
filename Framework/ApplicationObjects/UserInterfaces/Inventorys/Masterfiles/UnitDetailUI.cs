...
namespace NSites_V.ApplicationObjects.UserInterfaces.Inventorys.Masterfiles
{
    public partial class UnitDetailUI : Form
    {
        ...
        private void UnitDetailUI_Load(object sender, EventArgs e)
        {
            ...
            {
                ErrorMessageUI em = new ErrorMessageUI(ex.Message, this.Name, "UnitDetailUI_Load");
                em.ShowDialog();
                return;
            }
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                loUnit.Id = lId;
                loUnit.Code = GlobalFunctions.replaceChar(txtCode.Text);
                loUnit.Description = GlobalFunctions.replaceChar(txtDescription.Text);
                loUnit.Remarks = GlobalFunctions.replaceChar(txtRemarks.Text);
                loUnit.UserId = GlobalVariables.UserId;

                string _Id = loUnit.save(lOperation);
                if (_Id != "")
                {
